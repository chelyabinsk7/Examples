...
@FeignClient(url = "${openexchangerates.url}", name = "CURRENCY-CLIENT")
public interface CurrencyClient {
    ...
    @GetMapping("{date}.json?app_id={app_id}&base={base_currency}")
    public Currency getAllCurrency(@PathVariable("date") String date, 
					    		@PathVariable("app_id") String app_id,
					    		@PathVariable("base_currency") String base_currency);
}
